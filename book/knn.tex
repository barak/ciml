...
$\langle 6,1\rangle$ is given by $\sqrt{(2-6)^2 + (3-1)^2} = \sqrt{20}
\approx 4.47$.  In general, in $D$-dimensional space, the
...
\thinkaboutit{Why is the sign of the sum computed in lines 7-10 the
...
with a decision boundary that is really simple (like the boundary
